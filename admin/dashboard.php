...
<?php
        ...
        require_once "../connection.php";
         ...
         $next_week = 0;
            $i = 1;
        // total suspects
        $select_admins = "SELECT * FROM inmates";
...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Suspects</li>
                    <li class="list-group-item">Total Suspects : <?php echo mysqli_num_rows($total_admins); ?> </li>
                    <li class="list-group-item text-center"><a href="manage-inmates.php"><b>View All Suspects</b></a></li>
                </ul>
            </div>
        </div>
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Officers</li>
                    <li class="list-group-item">Total Officers : <?php echo mysqli_num_rows($total_emp); ?></li>
                    <li class="list-group-item text-center"><a href="manage-employee.php"> <b>View All Officers</b></a></li>
                </ul>
            </div>
        </div>
        <div class="col-4">
        ...
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Cases</li>
                    <li class="list-group-item">Total Cases : <?php echo mysqli_num_rows($total_cases); ?> </li>
                    <li class="list-group-item text-center"><a href="manage-cases.php"><b>View All Cases</b></a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-12">
            <div class=" text-center my-3 "> <h4>Officers Leadership Board</h4> </div>
            <table class="table  table-hover">
        <thead>
            <tr class="bg-dark">
            <th scope="col">S.No.</th>
            <th scope="col">Officers's Id</th>
            <th scope="col">Officers's Name</th>
            <th scope="col">Officers's Email</th>
