                   ...
                   <br> <br>       
                    <li>
                        <a href="./dashboard.php"  >
                            <i class="icon-home menu-icon"></i><span class="nav-text">Admin Dashboard</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="./manage-inmates1.php" >
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Manage Suspects</span>
                        </a>
                    </li>
                    <li>
                        <a href="./manage-cases.php" >
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Manage Cases</span>
                        </a>
                    </li>
                    <li>
                        <a href="./logout.php" >
