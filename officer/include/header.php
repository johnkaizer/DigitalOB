                   ...
                   <br> <br>       
                    <li>
                        <a href="./dashboard.php"  >
                            <i class="icon-home menu-icon"></i><span class="nav-text">Officer Dashboard</span>
                        </a>
                    </li>
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Report Cases</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./add-cases.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Add New Case</span></a></li>
                            <li><a href="./manage-cases.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">View All Cases</span></a></li>
                    ...
                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Book Suspects</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./add-inmates.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Add New Suspects</span></a></li>
                            <li><a href="./manage-inmates.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">View All Suspects</span></a></li>
                            <!-- <li><a href="./"> <i class="fa fa-bar-chart menu-icon"></i><span class="nav-text">Salary Table</span></a></li> -->
